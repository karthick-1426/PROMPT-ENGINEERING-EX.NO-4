...
### DATE:    24.05.2026                                                                        
### REGISTER NUMBER : 212223060114

# EXPERIMENT – 4  
# Prompt Engineering: Generation and Evaluation of Different Prompt Types
...
- To analyze the effectiveness and limitations of prompts.
- To improve prompt writing skills using refinement techniques.
...
Prompt Engineering is the process of designing effective instructions or questions for Artificial Intelligence models to generate accurate and meaningful outputs. A well-structured prompt improves the quality of AI responses.

Different prompt styles are used depending on the requirement such as comparison, storytelling, task execution, explanation, or problem-solving.
...
5:30 AM	Wake Up
6:00 AM	Exercise
7:00 AM	Study Session
9:00 AM	Breakfast
10:00 AM	College Work
...
Analyze output quality, clarity, and relevance.
Refine prompts and compare the outputs.
Study how prompt size affects AI response accuracy.
Record observations and evaluations.
